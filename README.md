...
Usage Instructions
Open ChatGPT or your configured Custom GPT platform.

Select DataScrub AI from your agent list or conversation starters.

Upload your CSV export or paste a raw data snippet into the prompt interface.

(Optional) Provide your company's primary HEX color code (e.g., #0F5132 for Executive Emerald or #500000 for Aggie Maroon) to custom-style all visual outputs.
...
def run_enterprise_cleaning_pipeline(df: pd.DataFrame) -> pd.DataFrame:
    ...
    return df
Glossary of Terms for Stakeholders
